...
- 🚧 **Tests**: 104 pytest cases covering the ledger invariants, concurrent-writer safety, the run-state projection's idempotency, the coordination layer, path-overlap rules, and the MCP tool surface (`backend/tests/`, runs in CI on 3.12).
