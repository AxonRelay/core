...
> 決定: 2026-08-30 / Status: 採用 / 関連: issue #21・#38（NATS JetStream 移行）, PR #35（Gemini 統合）
>
> **番号について:** 本文中の issue / PR 番号は、公開前の非公開リポジトリのものである。公開リポジトリには存在しないので、何を指すかは本文の記述で判断すること。
